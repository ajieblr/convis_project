...
if app_mode == "Webcam":
    ...
    # st.markdown("<div style='text-align: center;'><img src='.\image\convis.png' width='500'></div>", unsafe_allow_html=True)
    st.markdown("")
    ...
    st.markdown('')
    uploaded_file = st.file_uploader("Masukkan video (video harus direkam dari posisi atas kepala, video harus ad orang yang lewat, disarankan ada banyak orang yang lewat.)", type=["mp4", "avi", "mov", "mkv"])
    if uploaded_file is not None:
        ...
        while True:
            ...
            time.sleep(0.03)  # Adjust the speed of the video display
