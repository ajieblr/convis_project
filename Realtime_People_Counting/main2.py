...
# initialize the video writer (we'll instantiate later if needed)
writer = None
...
desired_fps = 24
# Calculate the delay per frame
delay_per_frame = 1.0 / desired_fps
...
while True:
    ...
    cv2.putText(frame, "-Prediction border - Entrance-",
                (10, H - 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
